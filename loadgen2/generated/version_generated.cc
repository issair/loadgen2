...
const std::string& LoadgenBuildDateLocal() {
  static const std::string str = "2026-06-01T19:35:09.805118";
  return str;
}

const std::string& LoadgenBuildDateUtc() {
  static const std::string str = "2026-06-01T11:35:09.805147";
  return str;
}

const std::string& LoadgenGitRevision() {
  static const std::string str = "9a95510bae";
  return str;
}

const std::string& LoadgenGitCommitDate() {
  static const std::string str = "2026-06-01T17:22:34+08:00";
  return str;
}
...
const std::string& LoadgenGitLog() {
  static const std::string str = R"LGVG_RSLD(9a95510baec5d7de0fda80ddeeb3c68f6c422976 docs:  Docker  build  run 
8d2f0f99c4ca57f315af49ea5caeaa8ecd9e58d5 docs:  split_codex_swebenchpro.py 
54d3aab1f787937fce612d21be986102e95a1566 docs: LoadGen 2.0overview.png
1f30151fd76914abcb93209dca17631e17489067 init project
