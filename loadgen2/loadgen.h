...
///
/// \brief SUT calls this to mark the start of processing for individual
/// samples within a query.
/// \details
/// Each call sets the per-sample start time on the SampleMetadata
/// identified by response->id.  When set, SampleComplete will use this
/// per-sample start time instead of the query-level issued_start_time.
/// This enables independent latency measurement for each sample in a
/// multi-sample query (e.g. dependency chains).
