...
struct PerformanceSummary {
  ...
  PercentileEntry latency_percentiles[7] = {{.50}, {.75}, {.90}, {.95},
                                            {.97}, {.99}, {.999}};
  ...
  PercentileEntry token_latency_percentiles[7] = {{.50}, {.75}, {.90}, {.95},
                                                  {.97}, {.99}, {.999}};
  PercentileEntry target_tpot_percentile{settings.target_latency_percentile};
  PercentileEntry tpot_percentiles[7] = {{.50}, {.75}, {.90}, {.95},
                                         {.97}, {.99}, {.999}};
